...
**Full-Stack Developer | AI Systems Architect | Digital Strategist**
...
Desenvolvedor Full-Stack com **10+ anos de experiência** construindo sistemas web escaláveis, landing pages de alta conversão e automações inteligentes com IA. Especialista em transformar requisitos complexos em produtos digitais que geram receita.

**Foco:** Desenvolvimento, tráfego pago e arquitetura de sistemas autônomos com IA.
...
![Claude](https://img.shields.io/badge/Claude-0369A1?style=flat-square&logo=anthropic&logoColor=white)
![Gemini](https://img.shields.io/badge/Gemini-8F7EFF?style=flat-square&logo=google&logoColor=white)
![CrewAI](https://img.shields.io/badge/CrewAI-FF6B35?style=flat-square&logoColor=white)

### 📊 Marketing & Growth

![Meta Ads](https://img.shields.io/badge/Meta%20Ads-0A66C2?style=flat-square&logo=meta&logoColor=white)
![Google Ads](https://img.shields.io/badge/Google%20Ads-4285F4?style=flat-square&logo=google&logoColor=white)
...
![GitHub Stats](https://github-readme-streak-stats.herokuapp.com?user=caiquecontarini&theme=tokyonight&hide_border=true)
...
- ✅ **Full-Stack**: React, Next.js, TypeScript, Supabase
- ✅ **Performance**: Otimização de Core Web Vitals, SSR/SSG
- ✅ **UX/UI**: Design responsivo, acessibilidade (WCAG)
- ✅ **E-commerce**: Integração com Stripe, payment processing
...
- ✅ **Paid Ads**: Meta Ads, Google Ads, TikTok Ads (ROI > 3x)
- ✅ **Landing Pages**: High-conversion copywriting + design
- ✅ **Growth Strategies**: Customer acquisition, retention
- ✅ **Analytics**: Pixel tracking, conversion optimization

---

## 🎓 Formação Contínua

- 🔬 Especialização em Prompt Engineering e Engenharia de IA
- 📚 Pesquisa em Sistemas Multi-Agentes e Automação Autônoma
...
**Sempre disponível para discussões sobre tecnologia, AI e crescimento digital.**
